...
<body class="w-full max-w-[80vw]">
    ...
    <div class="flex border border-b-#F2F2F2] border-t-#F2F2F2] my-5">
        ...
        <div class="flex">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none" class="tl"
    ...
    <a rel="noopener noreferrer" href="#">
        <img alt="" class=" object-cover w-full max-w-[80vw] h-52 bg-gray-500"
