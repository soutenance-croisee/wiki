    ...
    <nav
            ...
            <li>
                <div class=" relative mx-auto text-gray-600">
                    <input
                        ...
                        type="searchInput" id="searchInput" name="search" placeholder="search">
        ...
        <div class="hidden lg:flex">
            ...
            <?php else: ?>
                ...
                <a href="<?= URLROOT ?>/pages/MyWikis" class="bg-purple-800 text-white rounded-md px-4 py-2transition"
