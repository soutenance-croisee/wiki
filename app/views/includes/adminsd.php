                        ...
                        <ul class="pb-2 pt-1">
                            ...
                            <li>
                                <a href="#" target="_blank"
                                    ...
                                    <span class="ml-3 text-dark-500 text-sm font-light"
                                        sidebar-toggle-item="">Inbox</span>
                            ...
                            <li>
                                <a href="https://demos.creative-tim.com/soft-ui-flowbite/products"
                                    ...
                                    <div
                                        class="bg-white shadow-lg shadow-gray-300  text-dark-700 w-8 h-8 p-2.5 mr-1 rounded-lg text-center grid place-items-center">
                                        <svg class="text-dark" width="12px" height="12px" viewBox="0 0 42 44"
                            ...
                            <li>
                                <a href="#"
                                    ...
                                    <span class="ml-3 text-dark-500 text-sm font-light" sidebar-toggle-item="">Sign
                                        In</span>
                                </a>
                            </li>
                            <li>
                                <a href="https://demos.creative-tim.com/soft-ui-flowbite/sign-up"
                                    class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-gray-200 group transition-all duration-200"
                                    sidebar-toggle-collapse="">
                                    <div
                                        class="bg-white shadow-lg shadow-gray-300 text-dark-700 w-8 h-8 p-2.5 mr-1 rounded-lg text-center grid place-items-center">
